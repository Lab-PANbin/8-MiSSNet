...
def get_task_list():
    return list(tasks_voc.keys()) + list(tasks_ade.keys()) + list(tasks_cityscapes_domain.keys()) + list(tasks_aeroscapes.keys()) + list(tasks_whdld.keys()) + list(tasks_marseg.keys())
...
def get_task_labels(dataset, name, step):
    if dataset == 'voc':
        ...
        task_dict = tasks_aeroscapes[name]
    elif dataset == 'whdld':
        task_dict = tasks_whdld[name]
    elif dataset == 'marseg':
        task_dict = tasks_marseg[name]
    else:
